...
public class RegistroUsuario extends JFrame {
	...
	public RegistroUsuario() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(RegistroUsuario.class.getResource("/imagens/lOGO-50PX.png")));
		...
		txtDataN.setBounds(560, 278, 289, 38);
		txtDataN.getCalendarButton().setIcon(new ImageIcon(RegistroUsuario.class.getResource("/imagens/icon-reservas.png")));
		txtDataN.getCalendarButton().setBackground(SystemColor.textHighlight);
		txtDataN.setDateFormatString("dd/MMMM/yyyy");
		contentPane.add(txtDataN);
		
		txtNacionalidade = new JComboBox();
		txtNacionalidade.setBounds(560, 350, 289, 38);
		...
		lblTitulo.setBounds(560, 55, 300, 42);
		...
		btnsalvar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String date = ((JTextField) txtDataN.getDateEditor().getUiComponent()).getText();
				System.out.println(date);
				System.out.println(txtNacionalidade.getSelectedItem());
				System.out.println(txtTelefone.getText());
				//AQUI VAI SER IMPLEMENTADO MÉTODO PARA SALVAR NO BANCO DE DADOS UM NOVO USUARIO
			}
		});
		...
		imageFundo.setIcon(new ImageIcon(RegistroUsuario.class.getResource("/imagens/registro.png")));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroUsuario.class.getResource("/imagens/Ha-100px.png")));
	}
