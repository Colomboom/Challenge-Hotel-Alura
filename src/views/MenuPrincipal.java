...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		imagenFondo.setBounds(-50, 0, 732, 500);
		...
		JPanel btnCadastro = new JPanel();
		btnCadastro.setBackground(Color.WHITE);
		btnCadastro.setBounds(735, 450, 122, 44);
		panel.add(btnLogin);
		btnCadastro.setLayout(null);
		btnCadastro.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

		JLabel lblCadastro = new JLabel("Cadastre-se");
		lblCadastro.setBounds(0, 0, 122, 44);
		btnCadastro.add(lblCadastro);
		...
		lblCadastro.setFont(new Font("Roboto", Font.PLAIN, 15));
